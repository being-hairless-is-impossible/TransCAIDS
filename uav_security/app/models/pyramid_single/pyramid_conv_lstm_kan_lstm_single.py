...
from app.model.pyramid.blocks.kan import KANLinear
from app.model.pyramid.blocks.pyramid_conv import PyramidConv1D


class PyramidConvLSTMKAN(nn.Module):
    """
    ...
    def __init__(self,
        ...
        '''
        super(PyramidConvLSTMKAN, self).__init__()
        ...
        # Fully connected layers after LSTM using KANLinear
        self.fc = nn.Sequential(
            KANLinear(lstm_hidden_dim * 2, 512, base_activation=nn.Identity),
            nn.BatchNorm1d(512),
            nn.ReLU(),
            self.dropout,
            KANLinear(512, num_classes, base_activation=nn.Identity)
        )
